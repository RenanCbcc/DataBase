...
public class Inclui extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		try {
			...
			PreparedStatement statement = vinculo.getConexao()
					.prepareStatement("INSERT INTO Categoria (Descricao) Values(?)", Statement.RETURN_GENERATED_KEYS);
			...
			showMessageDialog(this, "Registro Gravado: " + rs.getInt(1) + "-" + this.tfDetail.getText());
			...
			showMessageDialog(this, ex.getMessage(), "Include Error", ERROR_MESSAGE);
		}
